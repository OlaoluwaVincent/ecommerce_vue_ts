<template>
    <v-container class="!max-w-screen-sm pa-0">
        <div class="flex items-center gap-4 mx-auto w-full justify-center bg-blue-lighten-3 rounded-lg mb-3 pa-4">
        ...
        <v-form v-model="valid" :loading="isPending">
            ...
            <h4 v-if="isError" class="text-red-700 font-semibold text-base text-center my-3">
                {{ error }}
            </h4>

            <v-btn @click="submit" block :disabled="isPending" color="success">
                Create </v-btn>
        </v-form>
